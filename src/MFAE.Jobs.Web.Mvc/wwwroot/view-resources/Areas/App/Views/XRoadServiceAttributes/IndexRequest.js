(function () {
    app.modals.XRoadServiceAttributesRequestIndex = function () {

        var tableId = 'XRoadServiceAttributesTableRequest' + new Date().getTime();
        $('table[name="XRoadServiceAttributesTableRequest"]').attr('id', tableId);
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/XRoadServiceAttributes/CreateOrEditModalRequest',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/XRoadServiceAttributes/_CreateOrEditModalRequest.js',
            modalClass: 'CreateOrEditXRoadServiceAttributeModalRequest'
        });
            ...
            listAction: {
                ...
                inputFilter: function () {
                    return {
                        ...
                        serviceAttributeTypeFilter:1,// $('#ServiceAttributeTypeFilterId').val(),
                        ...
                        xRoadServiceId: $("#XRoadServiceAttributes_XRoadServiceIdRequest").val()
                    };
                }
            },
            columnDefs: [
                        ...
                        items: [
                            {
                                ...
                                action: function (data) {
                                    ...
                                    abp.event.trigger('app.XRoadServiceAttributeViewRequest', { id: data.record.xRoadServiceAttribute.id });
        ...
        $('#CreateNewXRoadServiceAttributeButtonRequest').click(function () {
            _createOrEditModal.open({ xRoadServiceId: $("#XRoadServiceAttributes_XRoadServiceIdRequest").val() });
        });
