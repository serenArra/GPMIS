(function ($) {
    app.modals.CreateOrEditXRoadServiceAttributeMappingModalResponse = function () {
        ...
        this.save = function () {
            ...
            var xRoadServiceAttributeMapping = _$xRoadServiceAttributeMappingInformationForm.serializeFormToObject();
			 ...
			 _xRoadServiceAttributeMappingsService.createOrEdit(
               ...
               _modalManager.close();
                 abp.event.trigger('app.createOrEditXRoadServiceAttributeMappingModalSavedResponse');
			 }).always(function () {
