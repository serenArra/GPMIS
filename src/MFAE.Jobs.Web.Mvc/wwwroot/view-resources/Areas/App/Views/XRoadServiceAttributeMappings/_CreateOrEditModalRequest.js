(function ($) {
    app.modals.CreateOrEditXRoadServiceAttributeMappingModalRequest = function () {
        ...
        this.save = function () {
            ...
            var xRoadServiceAttributeMapping = _$xRoadServiceAttributeMappingInformationForm.serializeFormToObject();
			 ...
			 _xRoadServiceAttributeMappingsService.createOrEdit(
               ...
               _modalManager.close();
                 abp.event.trigger('app.createOrEditXRoadServiceAttributeMappingModalSavedRequest');
			 }).always(function () {
