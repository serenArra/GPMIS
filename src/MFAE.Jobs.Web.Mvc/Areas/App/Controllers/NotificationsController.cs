...
using MFAE.Jobs.Organizations;
using MFAE.Jobs.Web.Areas.App.Models.Notifications;
using MFAE.Jobs.Web.Areas.App.Models.OrganizationUnits;
...
namespace MFAE.Jobs.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class NotificationsController : JobsControllerBase
    {
