...
using MFAE.Jobs.Schemas;
using MFAE.Jobs.Web.Chat.SignalR;
using MFAE.Jobs.Web.Common;
using MFAE.Jobs.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using MFAE.Jobs.Web.Swagger;
using Stripe;
...
using MFAE.Jobs.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using MFAE.Jobs.Web.Extensions;
using MFAE.Jobs.Web.MultiTenancy;
using SecurityStampValidatorCallback = MFAE.Jobs.Identity.SecurityStampValidatorCallback;
...
namespace MFAE.Jobs.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<JobsWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (JobsConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Jobs API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("MFAE.Jobs.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "Jobs API", Version = "v1"});
                ...
                var applicationXml = $"MFAE.Jobs.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"MFAE.Jobs.Web.Core.xml";
