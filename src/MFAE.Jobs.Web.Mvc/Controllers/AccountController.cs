...
using MFAE.Jobs.Authentication.TwoFactor.Google;
...
{
    public class AccountController : JobsControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(JobsConsts.DateTimeOffsetFormat));
