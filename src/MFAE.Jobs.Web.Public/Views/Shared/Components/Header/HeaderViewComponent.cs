...
using MFAE.Jobs.Url;
using MFAE.Jobs.Web.Public.Startup;
using MFAE.Jobs.Web.Session;
using MFAE.Jobs.Web.UiCustomization;

namespace MFAE.Jobs.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : JobsViewComponent
    {
