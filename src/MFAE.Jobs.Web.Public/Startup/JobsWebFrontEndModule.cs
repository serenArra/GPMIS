...
namespace MFAE.Jobs.Web.Public.Startup
{
    ...
    public class JobsWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public JobsWebFrontEndModule(IWebHostEnvironment env, JobsEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(JobsWebFrontEndModule).GetAssembly());
        }
    }
}
