...
using MFAE.Jobs.Web.Startup.ExternalLoginInfoProviders;
...
namespace MFAE.Jobs.Web.Startup
{
    ...
    public class JobsWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public JobsWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(JobsWebHostModule).GetAssembly());
        }
