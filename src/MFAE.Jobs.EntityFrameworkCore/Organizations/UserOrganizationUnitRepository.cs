...
{
    public class UserOrganizationUnitRepository : JobsRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<JobsDbContext> dbContextProvider)
