...
using MFAE.Jobs.EntityFrameworkCore.Repositories;

namespace MFAE.Jobs.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : JobsRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<JobsDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
