...
{
    public class SubscriptionPaymentRepository : JobsRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<JobsDbContext> dbContextProvider)
