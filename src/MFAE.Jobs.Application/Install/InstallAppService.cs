...
namespace MFAE.Jobs.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : JobsAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<JobsDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{JobsConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{JobsConsts.ConnectionStringName}", constring);
        }
