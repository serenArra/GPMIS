...
using MFAE.Jobs.DemoUiComponents.Dto;

namespace MFAE.Jobs.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : JobsAppServiceBase, IDemoUiComponentsAppService
    {
