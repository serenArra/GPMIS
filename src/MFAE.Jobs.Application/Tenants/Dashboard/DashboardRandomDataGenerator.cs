...
using MFAE.Jobs.Tenants.Dashboard.Dto;

namespace MFAE.Jobs.Tenants.Dashboard
{
    public static class DashboardRandomDataGenerator
    {
        ...
        public static List<MemberActivity> GenerateMemberActivities()
        {
            ...
            {
                new MemberActivity("Brain", JobsConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%", "015-boy-6.svg"),

                new MemberActivity("Jane", JobsConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%","017-girl-8.svg"),

                new MemberActivity("Tim", JobsConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%", "004-boy-1.svg"),

                new MemberActivity("Kate", JobsConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
