...
{
    public class SessionAppService : JobsAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = JobsConsts.Currency,
                        CurrencySign = JobsConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = JobsConsts.AllowTenantsToChangeEmailSettings,
