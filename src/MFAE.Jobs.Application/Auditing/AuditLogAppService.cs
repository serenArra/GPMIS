...
using MFAE.Jobs.Auditing.Exporting;
using MFAE.Jobs.Authorization;
using MFAE.Jobs.Authorization.Users;
using MFAE.Jobs.Dto;
using MFAE.Jobs.EntityHistory;
using EntityHistoryHelper = MFAE.Jobs.EntityHistory.EntityHistoryHelper;

namespace MFAE.Jobs.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : JobsAppServiceBase, IAuditLogAppService
    {
