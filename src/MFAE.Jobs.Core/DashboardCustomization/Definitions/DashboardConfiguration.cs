    ...
    public class DashboardConfiguration
    {
        ...
        public DashboardConfiguration()
        {
            ...
            var dateRangeFilter = new WidgetFilterDefinition(
                JobsDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            var dailySales = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                "WidgetDailySales",
            ...
            var generalStats = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
            ...
            var profitShare = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                "WidgetProfitShare",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var memberActivity = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            var regionalStats = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                "WidgetRegionalStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var salesSummary = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                "WidgetSalesSummary",
                usedWidgetFilters: new List<string>() { dateRangeFilter.Id },
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            ...
            var topStats = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var incomeStatistics = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            var hostTopStats = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Host.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Host,
                permissionDependency: simplePermissionDependencyForHostDashboard
            );
            ...
            var editionStatistics = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            var subscriptionExpiringTenants = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            var recentTenants = new WidgetDefinition(
                JobsDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                "WidgetRecentTenants",
                side: MultiTenancySides.Host,
                usedWidgetFilters: new List<string>() { dateRangeFilter.Id },
                permissionDependency: simplePermissionDependencyForHostDashboard
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                JobsDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
            ...
            var defaultHostDashboard = new DashboardDefinition(
                JobsDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,
