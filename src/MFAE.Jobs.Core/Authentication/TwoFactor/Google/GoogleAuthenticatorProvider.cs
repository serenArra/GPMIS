...
namespace MFAE.Jobs.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : JobsServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("MFAE.Jobs", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
