...
namespace MFAE.Jobs.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : JobsServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours).ToString(JobsConsts.DateTimeOffsetFormat));
