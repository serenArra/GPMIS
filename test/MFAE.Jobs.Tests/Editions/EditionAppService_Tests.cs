...
namespace MFAE.Jobs.Tests.Editions
{
    ...
    public class EditionAppService_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Delete_Edition_If_There_Are_Subscriber_Tenants()
        {
            ...
            exception.Message.ShouldContain(_localizationManager.GetString(JobsConsts.LocalizationSourceName, "ThereAreTenantsSubscribedToThisEdition"));
        }
    }
}
