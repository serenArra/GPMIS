...
namespace MFAE.Jobs.Tests.Authorization.Users
{
    ...
    public class UserAppService_Link_Tests : UserAppServiceTestBase
    {
        ...
        private async Task<int> CreateTestTenantAndTestUser()
        {
            ...
            {
                ConnectionString = SimpleStringCipher.Instance.Encrypt("Server=localhost; Database=JobsTest_" + Guid.NewGuid().ToString("N") + "; Trusted_Connection=True;")
            };
