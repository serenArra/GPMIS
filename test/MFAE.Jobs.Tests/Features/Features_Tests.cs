...
namespace MFAE.Jobs.Tests.Features
{
    ...
    public class Features_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Create_User_More_Than_Allowed_Count()
        {
            ...
            exception.Message.ShouldContain(_localizationManager.GetString(JobsConsts.LocalizationSourceName, "MaximumUserCount_Error_Message"));
        }
    }
}
