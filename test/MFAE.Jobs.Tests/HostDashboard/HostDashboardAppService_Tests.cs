...
using MFAE.Jobs.MultiTenancy.HostDashboard;
...
namespace MFAE.Jobs.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(JobsDbContext context, SubscriptionPayment subscriptionPayment)
        {
